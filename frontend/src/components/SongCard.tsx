    ...
    <div className="mini-w-[180px] p-2 px-3 rounded cursor-pointer bg-[#ffffff26]">
      <div className="relative group">
        ...
        <div className="flex gap-2">
          ...
          <button className="absolute bottom-2 right-2 bg-green-500 text-black p-3 rounded-full opacity-0 group-hover:opacity-[100%] transition-opacity duration-300"><FaBookmark/></button>
        </div>
      </div>
